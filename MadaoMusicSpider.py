...
class Madao(Frame):
    ...
    def __init__(self):
        ...
        self.master.title("Madao")  # give it a title
    ...
    def __addText(self):
        ...
        self.text.configure(width=Madao.WIDTH, height=Madao.HEIGHT)

        # set color of input area
        self.text.configure(bg=Madao.BG_COLOR, font=Madao.FONT)
        self.text.configure(fg=Madao.FG_COLOR)
    ...
    def __addFileName(self):
        ...
        # set size of input area
        self.filetext.configure(width=Madao.WIDTH, height=1)

        # set color of input area
        self.filetext.configure(bg=Madao.BG_COLOR, font=Madao.FONT)
        self.filetext.configure(fg=Madao.FG_COLOR)
    ...
    def __addDirectory(self):
        ...
        self.dirButton["width"] = Madao.PATH_WIDTH
        self.dirButton["height"] = Madao.BUTTON_HEIGHT
        self.dirButton["bg"] = Madao.BUTTON_COLOR
        self.dirButton["fg"] = Madao.BG_COLOR
    ...
    def __addButton(self):
        ...
        self.button["width"] = Madao.BUTTON_WIDTH
        self.button["height"] = Madao.BUTTON_HEIGHT
        self.button["bg"] = Madao.BUTTON_COLOR
        self.button["fg"] = Madao.BG_COLOR
